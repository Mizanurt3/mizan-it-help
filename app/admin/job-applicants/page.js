...
export default function JobApplicantsAdmin() {
  ...
  function handleEdit(app) {
    setForm({
      ...
      father: app.father || "", father_bn: app.father_bn || "", mother: app.mother || "",
      mother_bn: app.mother_bn || "", religion: app.religion || "", gender: app.gender || "",
      marital_status: app.marital_status || "", spouse_name: app.spouse_name || "",
      email: app.email || "", quota: app.quota || "", dep_status: app.dep_status || "",
      ...
      ssc_year: app.ssc_year || "", ssc_group: app.ssc_group || "", ssc_result_type: app.ssc_result_type || "",
      ssc_result: app.ssc_result || "",
      hsc_exam: app.hsc_exam || "", hsc_board: app.hsc_board || "", hsc_roll: app.hsc_roll || "",
      hsc_year: app.hsc_year || "", hsc_group: app.hsc_group || "", hsc_result_type: app.hsc_result_type || "",
      hsc_result: app.hsc_result || "",
      gra_exam: app.gra_exam || "", gra_subject: app.gra_subject || "", gra_institute: app.gra_institute || "",
      gra_year: app.gra_year || "", gra_duration: app.gra_duration || "", gra_result_type: app.gra_result_type || "",
      gra_result: app.gra_result || "",
      mas_exam: app.mas_exam || "", mas_subject: app.mas_subject || "", mas_institute: app.mas_institute || "",
      mas_year: app.mas_year || "", mas_duration: app.mas_duration || "", mas_result_type: app.mas_result_type || "",
      mas_result: app.mas_result || ""
    });
    setEditingMobile(app.mobile);
      ...
      <form onSubmit={handleSave} style={{ background: "#f9f9f9", padding: "35px", borderRadius: "12px", boxShadow: "0 4px 25px rgba(0,0,0,0.1)", marginBottom: "50px" }}>
        ...
        <div style={{ textAlign: "center", marginTop: "50px" }}>
          <button type="submit" disabled={saving} style={{ padding: "16px 60px", background: "#006400", color: "white", border: "none", borderRadius: "8px", fontSize: "18px", marginRight: "15px" }}>
            {saving ? "Saving..." : editingMobile ? "Update Applicant" : "Save New Applicant"}
          </button>
          <button type="button" onClick={resetForm} style={{ padding: "16px 40px", background: "#666", color: "white", border: "none", borderRadius: "8px" }}>
            Clear Form
          </button>
        </div>
      </form>
              ...
              {filteredApplicants.map(app => (
                <tr key={app.mobile}>
                  ...
                  <td>
                    ...
                    <button onClick={() => handleDelete(app.mobile)} style={{ padding: "8px 18px", background: "#dc2626", color: "white", border: "none", borderRadius: "5px" }}>Delete</button>
                  </td>
                </tr>
              ))}
            </tbody>
