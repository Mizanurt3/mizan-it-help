  ...
  try {
    ...
    const result = await pool.query(`
      ...
      ON CONFLICT (mobile) DO UPDATE SET
        ...
        ssc_year = EXCLUDED.ssc_year, ssc_group = EXCLUDED.ssc_group, ssc_result_type = EXCLUDED.ssc_result_type,
        ssc_result = EXCLUDED.ssc_result,
        hsc_exam = EXCLUDED.hsc_exam, hsc_board = EXCLUDED.hsc_board, hsc_roll = EXCLUDED.hsc_roll,
        hsc_year = EXCLUDED.hsc_year, hsc_group = EXCLUDED.hsc_group, hsc_result_type = EXCLUDED.hsc_result_type,
        hsc_result = EXCLUDED.hsc_result,
        gra_exam = EXCLUDED.gra_exam, gra_subject = EXCLUDED.gra_subject, gra_institute = EXCLUDED.gra_institute,
        gra_year = EXCLUDED.gra_year, gra_duration = EXCLUDED.gra_duration, gra_result_type = EXCLUDED.gra_result_type,
        gra_result = EXCLUDED.gra_result,
        mas_exam = EXCLUDED.mas_exam, mas_subject = EXCLUDED.mas_subject, mas_institute = EXCLUDED.mas_institute,
        mas_year = EXCLUDED.mas_year, mas_duration = EXCLUDED.mas_duration, mas_result_type = EXCLUDED.mas_result_type,
    ...
    return Response.json({ 
      status: "error", 
      message: error.message.includes("jwt") ? "Invalid token" : "Failed to save data" 
    }, { status: 500 });
  }
}