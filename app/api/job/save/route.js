...
export async function POST(request) {
  try {
    ...
    if (!data.mobile || !data.userMobile) {
      return Response.json({ 
        status: "error", 
        message: "customerMobile and userMobile are required" 
      }, { status: 400 });
    }

    const values = [
      data.mobile,                    // $1  customerMobile
      data.userMobile,                // $2  userMobile
      data.name || null,
      data.name_bn || null,
      data.father || null,
      data.father_bn || null,
      ...
      data.present_post || null,
      data.present_postcode || null,
      data.present_upazila || null,
      data.permanent_careof || null,
      data.permanent_village || null,
      data.permanent_district || null,
      data.permanent_post || null,
      data.permanent_postcode || null,
      data.permanent_upazila || null,
      data.ssc_exam || null,
      data.ssc_board || null,
      data.ssc_roll || null,
      data.ssc_year || null,
      data.ssc_group || null,
      data.ssc_result_type || null,
      data.ssc_result || null,
      data.hsc_exam || null,
      data.hsc_board || null,
      data.hsc_roll || null,
      data.hsc_year || null,
      data.hsc_group || null,
      data.hsc_result_type || null,
      data.hsc_result || null,
      data.gra_exam || null,
      data.gra_subject || null,
      data.gra_institute || null,
      data.gra_year || null,
      data.gra_duration || null,
      data.gra_result_type || null,   // $53
      data.gra_result || null,
      data.mas_exam || null,
      data.mas_subject || null,
      data.mas_institute || null,
      data.mas_year || null,
    ...
    const result = await pool.query(`
      INSERT INTO job_data (
        "customerMobile", "userMobile", name, name_bn, father, father_bn, mother, mother_bn,
